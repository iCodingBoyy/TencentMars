#
#  Be sure to run `pod spec lint mars.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "mars"
  s.version      = "1.0.0"
  s.summary      = "腾讯Mars-Xlog库，只编译了xlog部分"
  ...
  s.homepage     = "https://github.com/myz1104/TencentMars"
  ...
  s.source       = { :git => "https://github.com/myz1104/TencentMars.git", :tag => "#{s.version}" }
